...
?>
    <body data-smooth-scroll-offset="77">
        ...
        <div class="main-container">
            <section class="cover cover-features imagebg text-center section--ken-burns space--md" data-overlay="2">
                    ...
                    <div class="row">
                        <div class="col-sm-10 col-md-12">
                            <div class="typed-headline">
                                <i>
                                <span class="h1 inline-block color--blue-ski">Viví experiencias</span>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-5">
                            ...
                            <p class="lead">No olvides en consultarnos cualquier duda que tengas, nos esforzamos por responder a todas las consultas en le menor tiempo posible. <br></p>
