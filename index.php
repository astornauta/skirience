                ...
                <div class="container pos-vertical-center">
                    <div class="row">
                        <div class="col-md-5 col-sm-7 text-center">
                            <h3><b><i>Conocer tus deseos para poder diseñar un viaje personalizado es fundamental para SKIRIENCE</i></b></h3>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-5">
                            ...
                            <p class="lead">No olvides consultarnos cualquier duda que tengas, nos esforzamos por responder a todas las consultas en el menor tiempo posible. <br></p>
