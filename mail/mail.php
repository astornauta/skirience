...
// Prepara conexión DB
require_once("open_conexion.php");
...
if (isset($_POST["consulta"])) {
    ...
    empty($_POST['Baquera_Beret,España']) ? $destino_baqueria_espana = 'NO' : $destino_baqueria_espana = 'SI';
    ...
    $cantidad_ninos = $_POST['cantidad_niños'];
    $edad_promedio_ninos = $_POST['edad_promedio_niños'];
    ...
    $keys = [
      ...
      'lugar_inicio_viaje',
      'destino_chapelco',
      'destino_aspen_colorado',
      'destino_laslenas_argentina',
      'destino_grandvalira_andorra',
      'destino_baqueria_espana',
      'destino_niseko_japon',
      'destino_sierra_nevada',
      'destino_otro',
      'fecha_desde',
      'fecha_hasta',
      'fechas_flexibles',
    ...
    $fields_db = implode(',', $keys);
    $prepared_values =  ":";
    $prepared_values .= implode(', :', $keys);
    $values = compact($keys);

    // Guardo en DB
    $tabla_db = "formulario";
    $query_formulario= "INSERT INTO $tabla_db ($fields_db) VALUES ($prepared_values);";
    try {
      $sth = $conexion_db->prepare($query_formulario);
      $sth->execute($values);
    }catch (Exception $e){
    ...
    $message .= "<br><br><b>Baqueria España:</b> " . $destino_baqueria_espana;
    ...
    $message .= "<br><br><b>Cantidad de niños:</b> " . $cantidad_ninos;
    $message .= "<br><br><b>Edad promedio de los niños:</b> " . $edad_promedio_ninos;
