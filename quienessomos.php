        ...
        <div class="main-container">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-10 col-md-8">
                            ...
                            <p class="lead">Somos Caro y Salva, dos profesionales del esquí con muchos años de experiencia. Hemos trabajado por España, Argentina y EEUU con todo tipo de alumnos, y entre bajada y bajada, hemos pasado muchas horas encima del telesilla mientras charlábamos de todo tipo de temas con ustedes</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="container pos-vertical-center">
                    <div class="row">
                        <div class="col-sm-8 col-md-7">
                            <p class="lead"><b>Nuestro objetivo es proponerte distintos destinos de esquí y facilitarte los servicios que desees.</b></p>
                        </div>
                    </div>
                </div>
            </section>
            <section class="cover text-center text-left-sm space--sm bg--ski">
                <div class="container pos-vertical-center">
                    <div class="row">
                        <div class="col-sm-8 col-md-7">
                            <p class="lead padding-top-sm"><b>Algunas de nuestras recomendaciones:</b></p>
                        </div>
                    </div>
                </div>
            </section>
